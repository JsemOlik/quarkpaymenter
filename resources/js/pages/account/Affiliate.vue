...
const affiliateLink = ref('https://quarkpay.io?ref=AuLbVdYlhG');
        ...
        <SettingsLayout>
            <div class="space-y-12">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                    <div class="bg-gradient-to-br from-neutral-900 to-neutral-800 rounded-2xl p-8 border border-neutral-700 shadow-lg flex items-center gap-4 transition-transform group">
                        <div class="flex items-center justify-center w-14 h-14 rounded-xl bg-blue-500/20 transition-colors">
                    ...
                    <div class="bg-gradient-to-br from-neutral-900 to-neutral-800 rounded-2xl p-8 border border-neutral-700 shadow-lg flex items-center gap-4 transition-transform group">
                        <div class="flex items-center justify-center w-14 h-14 rounded-xl bg-green-500/18 transition-colors">
                    ...
                    <div class="bg-gradient-to-br from-neutral-900 to-neutral-800 rounded-2xl p-8 border border-neutral-700 shadow-lg flex items-center gap-4 transition-transform group">
                        <div class="flex items-center justify-center w-14 h-14 rounded-xl bg-yellow-500/18 transition-colors">
